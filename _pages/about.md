...
---
## About Me 
This is, Chiyu(Henry) Ma, a second-year Ph.D. student in Computer Science at Dartmouth College, advised by Prof. [Soroush Vosoughi](https://www.cs.dartmouth.edu/~soroush//). My research focuses on trustworthy AI, with a particular emphasis on the interpretability of models in computer vision (CV) and natural language processing (NLP). Currently, I approach model interpretability by implementing clustering algorithms within the model's latent space, enabling the extraction of meaningful semantic representations. These representations are integrated into carefully designed reasoning processes that enhance model transparency. By aligning the model's reasoning and visualizations with human reasoning through novel loss functions and training mechanisms, I aim to create models that are both explainable and aligned with human understanding. In the short term, my research interest lies at the intersection of model interpretability and reasoning, encompassing both computer vision and large language models (LLMs). In the long term, I aim to design and develop intrinsically interpretable algorithms that enhance AI transparency and trustworthiness.
