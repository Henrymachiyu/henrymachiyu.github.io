...
My research focuses on developing interpretable and reliable machine learning methods that promote transparency, fairness, and usability across a variety of applications. I have worked extensively on prototype-based and vision transformer models for image understanding, as well as statistical modeling and visualization techniques that make complex AI systems easier to understand. These approaches have been applied in areas
such as information analysis, and other decision-support systems. More recently, I have extended these principles to advanced language-based systems, aiming to make their outputs clearer, more consistent, and more accessible for a broad range of users.
